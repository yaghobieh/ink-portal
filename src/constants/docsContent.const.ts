...
`,
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: 'Built in: Titles (style gallery), Sheet (grid + CSV), and Graph (bar, line, pie). They ship on the toolbar and slash menu when those features are on.',
      },
      {
        type: 'html',
        ...
        items: [
          {
            ...
            body: 'npx i @forgedevstack/ink then npx @forgedevstack/ink --plugin titles graph theme excel',
          },
          {
...
setHtml(result.html);`,
      ...
      },
      {
        ...
        items: [
          {
            title: 'npx --plugin (today)',
            body: 'npx @forgedevstack/ink --plugin excel — or titles, graph, theme. Best for apps and CI.',
          },
          {
